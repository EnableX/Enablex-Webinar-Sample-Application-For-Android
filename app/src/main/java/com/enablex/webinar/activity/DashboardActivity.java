...
import com.enablex.webinar.ApplicationController;
import com.enablex.webinar.R;
import com.enablex.webinar.web_communication.WebCall;
import com.enablex.webinar.web_communication.WebConstants;
import com.enablex.webinar.web_communication.WebResponse;
...
public class DashboardActivity extends AppCompatActivity implements View.OnClickListener, WebResponse {
    ...
    public void onClick(View view) {
        int id = view.getId();
           Log.i("DashboardActivity", "onClick: " + id);
    ...
    private void getRoomTokenWebCall() {
        ...
        if (!name.getText().toString().isEmpty() && !roomId.getText().toString().isEmpty()) {
            // sandeep new WebCall(this, this, jsonObject, WebConstants.getTokenURL, WebConstants.getTokenURLCode, false, false).execute();
            new WebCall(this, this, jsonObject, room_Id+ File.separator+WebConstants.getTokenURL, WebConstants.getTokenURLCode, false, false).execute();
        }
    }
